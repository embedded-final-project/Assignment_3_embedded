...
;temp.c,13 :: 		void Temp_Read(int ADC_pin){
...
;temp.c,21 :: 		void Display_Temp(float Temp_reading){
;temp.c,22 :: 		if (Temp_reading>35){
...
;temp.c,23 :: 		Lcd_Out(2,1,"Decreasing"); }
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
...
L_Display_Temp1:
;temp.c,24 :: 		else if(Temp_reading<=30){
	MOVF        FARG_Display_Temp_Temp_reading+0, 0 
	MOVWF       R4 
	MOVF        FARG_Display_Temp_Temp_reading+1, 0 
	MOVWF       R5 
...
;temp.c,25 :: 		Lcd_Out(2,1,"Increasing");
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
